...
"""
    ...
    DOCKER INVOCATION REQ:
        docker run -dit --name r2hdp --net=host \
            ...
            -w /home/ubuntu/HumbleDave2/ros2ws --privileged r2hdp 

    CONTROL VOLUME: (cmds/set_vol_very_low.sh)
        #!/bin/bash
        # FILE: cmds/set_vol_very_low.sh
        amixer -D pulse sset Master 10%
        ~/HumbleDave2/ros2ws/cmds/say.sh 'Volume set very low 10 percent'
...
# voicedir = os.path.expanduser('~/HumbleDave2/models/piper-tts/') #Where onnx model files are stored on my machine
voicedir = '/home/ubuntu/HumbleDave2/models/piper-tts/'  # Where onnx model files are stored on my machine
...
class SayService(Node):
    ...
    def __init__(self):
        ...
        self.loghandler = logging.FileHandler('/home/ubuntu/HumbleDave2/logs/speak.log')
