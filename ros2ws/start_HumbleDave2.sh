...
<< ////
    FILE:  /home/ubuntu/HumbleDave2/ros2ws/start_HumbleDave2.sh

This file starts the needed 9 HumbleDave2 nodes (8 python processes in status.sh):
...
echo "*** with URDF file: ros2_gopigo3_node/humbledave2.urdf"
