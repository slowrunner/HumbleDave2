...
class Metaclass_Dock(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dave_interfaces.srv import _dock
...
class Dock(metaclass=Metaclass_Dock):
    from dave_interfaces.srv._dock import Dock_Request as Request
    from dave_interfaces.srv._dock import Dock_Response as Response
