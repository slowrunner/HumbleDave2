...
#include "dave_interfaces/srv/detail/undock__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dave_interfaces::srv::Undock_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dave_interfaces::srv::Undock_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dave_interfaces::srv::Undock_Request *>(
    untyped_ros_message);
...
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_Undock_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dave_interfaces::srv::Undock_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dave_interfaces::srv::Undock_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dave_interfaces::srv::Undock_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_Undock_Response__handle;
}
...
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_Undock__handle;
}
